...
`compact_shared_through` performs no destructive CRDT pruning and the shared
journal is retained. Presence and wall-clock age do not weaken this rule.
Manager removal is the only operation that ends an offline device's retention
claim.
