...
///
/// This config controls local subscriptions and polling only. It deliberately
/// makes no claim about future distributed placement, permissions, output
/// fencing, or lifecycle policy.
#[derive(Debug, Clone, PartialEq, Encode, Decode)]
pub struct OperatorRuntimeConfig {
    /// Table subscriptions used by the current native worker ABI.
